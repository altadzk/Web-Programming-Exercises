	...
	<div class="container mx-auto" style="width: 80%; margin-top: 5%;">
        <form method="post" action="cek.php">
            <div class="card bg-dark">
				<div style="background-image: url('https://i.pinimg.com/564x/60/f8/4b/60f84bc6b48bffe1ea4b30b9239d5372.jpg');" class="card-header bg-dark text-center">
					<h3 style="text-align: center; color: #59ff00" class="card-header bg-dark text-center">Game Matematika</h3>
				</div>
			</div>
